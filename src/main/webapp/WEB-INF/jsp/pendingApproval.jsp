...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
                            ...
                            <div class="card card-primary ">
                                <div class="card-body ">
                                    <form role="form" id="addForm" autocomplete="off">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <button type="button" id="selectDropDown" style="width: inherit;" class="btn btn-primary">Search</button>
                                            </div>

                                            <div class="col-md-2">
                                                <input id="flipToInvoice" type="button" style="width: inherit;" class="btn btn-primary" value="Approve Trips" />
                                            </div>

                                            <div class="col-md-2">
                                                <div class="dropdown">
                                                    <button type="button" class="btn btn-primary dropdown-toggle" style="width: inherit;" data-toggle="dropdown">Export
                                                        Details</button>
                                    ...
                                    <table class="table table-bordered table-hover" id="tabledata">
                                        <thead>
                                            <tr>
                                                <th class="bg-primary"><button type="button" id="checkButton" class="btn btn-default btn-sm checkbox-toggle">
                                                ...
                                                <th class="bg-primary" style="padding: 5px 5px 5px 1.5rem;">Billable
                                                    KM</th>
                                                <th class="bg-primary" style="padding: 5px 5px 5px 1.5rem;">Actual
                                                    Arrival / Departure</th>
                                        ...
                                        <div class="card-body" style="padding-bottom: inherit;">
                                            <form role="form" id="tripForm" autocomplete="off">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5" title="Opening Reading">Opening
                                                                Reading</label>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" placeholder="Trip Strating reading" maxlength="5" id="openingReading" name="openingReading">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5" title="Closing Reading">Closing
                                                                Reading</label>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" placeholder="Trip Closing reading" id="closingReading" maxlength="5" name="closingReading">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3" title="Remarks">Remarks</label>
                                                            <div class="col-sm-9">
                                                                <textarea class="form-control" id="comment" name="comment" maxlength="250" required="required" placeholder="Remarks if any" rows="1"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-grid gap-2 col-6 mx-auto">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" style="margin-right: 10px; width: inherit;">Approve</button>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <button id="openCoaDetails" type="button" class="btn btn-success" style="margin-right: 10px; width: inherit;">Query</button>
                                                            </div>
                                                            <div class="col-sm-4">
    ...
    <script src="js/pendingApproval.js"></script>
</body>
