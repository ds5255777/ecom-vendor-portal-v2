...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
	<div class="wrapper">
		...
		<jsp:include page="navbar.jsp?pagename=Ehs Verification" />
		<jsp:include page="ehsVerificationBar.jsp?pagename=Ehs Verification" />
	...
	<script src="js/ehsVerification.js"></script>
</body>
