...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <li>
            <button type="button" id="productConversion" style="background-color: #007bff; color: #fff; visibility: hidden;" class="btn btn-primary btn-sm">
                <i class="fa fa-eye" aria-hidden="true"></i>&nbsp;Product Conversion
            </button>
        </li>&nbsp;
        <li>
            <button type="button" id="chasisChangeOver" style="background-color: #007bff; color: #fff; visibility: hidden;" class="btn btn-primary btn-sm">
                <i class="fa fa-eye" aria-hidden="true"></i>&nbsp;Chasis Change Over
            </button>
        </li>&nbsp;
        <li>
            <button type="button" id="viewAttachment" style="background-color: #007bff; color: #fff; visibility: hidden;" class="btn btn-primary btn-sm">
                <i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View Attachment
            </button>
        </li>
        <li class="nav-item"><a class="nav-link">${userName}</a></li>
        <c:if test="${pageName == 'All License'}">
            <li class="nav-item">
                <button class="btn btn-default float-right" id="newLicense">
