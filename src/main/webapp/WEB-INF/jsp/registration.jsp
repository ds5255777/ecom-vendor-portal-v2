        ...
        <div class="container-fluid" style="margin-left: 0px; width: 100%; ">
            <div id="smartwizard" style="background: white; padding: 20px;">
                <ul>
                    ...
                    <li style="margin: auto; margin-left: auto;"><a href="#step-5">Step-5<br /> <small>Documents</small></a></li>
                    <li id="step6Id" style="margin: unset; margin-left: auto;"><a href="#step-6">Step-6<br /> <small>Query</small></a></li>
                </ul>
                <div>
                    <div id="step-1" class="">
                    ...
                    <div id="step-6" class="">
                        <div class="card queryFormUi" style="display: none; margin-bottom: 10px;">
                            ...
                            <div id="queryBookHeadData" aria-labelledby="queryBookHead" style="border-style: solid; border-width: 1px; border-color: #11aef6;">
                                    ...
                                    <table class="table center-aligned-table" id="fromTable">
                                        <tbody>
                                            <tr class="container">
                                                ...
                                                <td style="width: 150px;"><button type="Button" class="btn btn-primary" id="addSupplierQueryBtn" name="addSupplierQueryBtn" onclick="saveRemarks()">Add Remarks</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </form>
