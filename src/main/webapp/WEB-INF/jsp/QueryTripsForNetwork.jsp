													...
													<div class="row">
															...
															<div class="form-group row">
																...
																<div class="col-sm-7">
																	<select class="form-control" onchange="getBpCode()"
																		...
																		<c:forEach items="${vendorNamefortripsQuery}"
																			var="vendorName">
															...
															<div class="form-group row">
																...
																<div class="col-sm-7">
																	<input type="text" class="form-control" id="vendorCode"
																		name="vendorCode" readonly="readonly"
																		autocomplete="off">
														...
														<div class="col-md-3">
															<div class="form-group row">
																...
																<div class="col-sm-7">
																	<input type="text" class="form-control"
																		id="totalFreight" name="totalFreight"> <input
															...
															<div class="form-group row">
																...
																<div class="col-sm-4">
																	<button type="button" class="btn btn-warning"
																		style="margin-right: 10px; width: inherit"
																		id="recalculate" onclick="refreshValues()">Refresh</button>
																</div>
																<div class="col-sm-4">
