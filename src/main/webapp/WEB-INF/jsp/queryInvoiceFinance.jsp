...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    ...
    <div class="wrapper">
        ...
        <jsp:include page="navbar.jsp?pagename=Query Invoice" />
         ...
         <jsp:include page="slidebar_Finance.jsp?pagename=QueryInvoiceFinance" />
                    ...
                    success: function(data) {
                        ...
                        if (data.msg == 'success') {
                            ...
                            for (var i = 0; i < result.length; i++) {
                                ...
                                var view = "<a href=\"#\" data-toggle=\"modal\" data-target=\"#tripValue\" onclick=\"getInvoiceDataFormDataByInvoiceNumber('" + result[i].ecomInvoiceNumber + "','Query Invoice')\" >" + result[i].ecomInvoiceNumber + "</button>";
