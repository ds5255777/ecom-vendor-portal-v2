...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
	<div class="wrapper">
		...
		<%
		String typeOfVendor = GlobalConstants.VENDOR_FIXED_ASSETS;
		request.setAttribute("typeOfVendor", typeOfVendor);
			...
			<div class="content-header" style="padding: 0px;">
				<div class="container-fluid">
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<input type="hidden" id="vendorType" value="${vendorType }">
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-2 col-6">
							<div class="small-box bg-white">
								<div class="inner">
									...
									<p id="iamwatch" data-toggle="tooltip" data-placement="bottom">Unprocessed
										PO</p>
								</div>
								<div class="icon">
									<i class="fa fa-tasks"
						...
						<div class="col-lg-2 col-6">
							...
							<div class="small-box bg-white">
								<div class="inner">
									...
									<p id="UnTickets" data-toggle="tooltip" data-placement="bottom">Processed
										PO</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-2 col-6">
							...
							<div class="small-box bg-white">
								<div class="inner">
									...
									<p id="invdue" data-toggle="tooltip" data-placement="bottom">All
										Invoice</p>
								</div>
								<div class="icon">
						...
						<div class="col-lg-2 col-6">
							...
							<div class="small-box bg-white">
								<div class="inner">
									...
									<p id="invdue" data-toggle="tooltip" data-placement="bottom">Draft
										Invoice</p>
								</div>
								<div class="icon">
							...
							<div class="card card-primary  card-outline ">
								<div class="card-header">
									<h3 class="card-title" id="lastInvoice" data-toggle="tooltip"
										data-placement="bottom" title="Top 15 Users">
										<strong>Top 50 Unprocessed PO</strong>
									</h3>
								</div>
