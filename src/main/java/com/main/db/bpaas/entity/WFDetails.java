...
@NamedQueries({
    @NamedQuery(name = "WFDetails.findUserPending", query = "select w from WFDetails w where w.status = 'RUNNING' and w.assignedTo=:userName"), 
...
public class WFDetails {
    ...
    public Date getIntroducedOn() {
        return introducedOn;
    }

    public void setIntroducedOn(Date introducedOn) {
