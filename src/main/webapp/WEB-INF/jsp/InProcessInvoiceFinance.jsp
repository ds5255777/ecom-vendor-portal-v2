...
<head>
    ...
    <title>${titleName}|In-Process Invoice</title>
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    ...
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <jsp:include page="navbar.jsp?pagename=In-Review Trip Invoice" />
        <!-- /.navbar -->
        ...
        <script type="text/javascript">
            ...
            function getData() {
                ...
                $.ajax({
                    type: "POST",
                    data: "",
                    url: "<%=GlobalUrl.getAllInReviewInvoice%>",
                    dataType: "json",
                    ...
                    success: function(data) {
                        ...
                        if (data.msg == 'success') {
                            ...
                            for (var i = 0; i < result.length; i++) {
                                ...
                                var view = "<a href=\"#\" data-toggle=\"modal\" data-target=\"#tripValue\" onclick=\"getInvoiceDataFormDataByInvoiceNumber('" + result[i].ecomInvoiceNumber + "','In-Processed Invoice')\" >" + result[i].ecomInvoiceNumber + "</button>";
