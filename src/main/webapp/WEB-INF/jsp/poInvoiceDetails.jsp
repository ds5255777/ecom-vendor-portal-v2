...
<head>
    ...
    <title>${titleName}| Invoice Details</title>
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    ...
    <div class="wrapper">
        ...
        <jsp:include page="navbar.jsp?pagename=Invoice Details" />

        <jsp:include page="slidebar_Po.jsp?pagename=poInvoiceDetails" />
    ...
    <script src="js/poInvoiceDetails.js"></script>
</body>
