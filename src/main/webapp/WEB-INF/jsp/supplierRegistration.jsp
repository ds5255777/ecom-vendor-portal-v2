...
<body>
			...
			<div id="smartwizard" style="background: white; padding: 20px;">
				...
				<div>
										...
										<table class="table center-aligned-table addTable"
											...
											<tbody>
												...
												<tr class="">
													...
													<%--  <td><label for="partnerType">Supplier</label></td>
										...
										<table class="table center-aligned-table" id="fromTable"
											...
											<tbody>
												...
												<tr class="">
													...
													<td colspan="2"><select
														class="js-example-basic-multiple select2" name="supplierTypeInContact"
														id="supplierTypeInContact" multiple="multiple">
															<c:forEach items="${business}" var="bus">

																<option value="${bus}">${bus}</option>
															</c:forEach>
													</select></td>
														<td><label for="addressDetailsInContact">Address Type<span class="required adHocRequired">*</span>
													</label></td>
													<td class="selectAddressTypeInputInContact" id="selectAddressTypeInContact"
														 colspan="2"><select
														id="addressTypeInContact" name="addressTypeInContact"
														class="form-control p-input" >
														<option value="">--Select--</option>
									...
									<form id="stepSixForm" class="forms-sample">
										<table class="table center-aligned-table" id="fromTable"
											...
											<tbody>
												...
												<tr class="">
													<td><label for="paymentMethod123">Payment Method<span
															class="required adHocRequired">*</span></label></td>
												...
												<tbody>
													<tr class="">
														...
														<td colspan="2"><select id="tdsSection"
															...
															colspan="2" placeholder="TDS Section">
																<option value="">Select</option>
													...
													<tbody>
														...
														<tr>
															<td><label>ITR Filling Declaration<span
																	class="required notRequreDocument">*</span></label></td>
					...
					<div class="card-footer" align="center">
						...
						<button type="button" class="btn btn-primary" id="closePopBtn">Close</button>
					</div>
	...
	<script src="js/supplierRegistration.js"></script>
