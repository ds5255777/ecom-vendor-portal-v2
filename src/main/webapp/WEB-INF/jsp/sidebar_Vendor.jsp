...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<input type="hidden" id="suppNames" value="${userName}"> <a
		href="dashboard" class="brand-link"> <img src="${logoPath}"
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="allTrips"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="closedTrips"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="closedAndApprovedTrips"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="inTransitTrips"
							class="nav-link
	...
	out.print("active");
				...
				<li class="nav-item"><a
					href="${pageContext.request.contextPath}/pendingApproval"
					class="nav-link 
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="invoicesQueue"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="pendingInvoice"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="approvedInvoice"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="draftInvoice"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="queryInvoice"
							class="nav-link
	...
	out.print("active");
				...
				<li class="nav-item"><a
					href="${pageContext.request.contextPath}/vendorProfile"
					class=" nav-link <%if (request.getParameter("pagename").equalsIgnoreCase("vendorProfile")) {
				out.print("active");
			}%>">
