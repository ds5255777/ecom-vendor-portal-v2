...
public class PasswordEmail {
    ...
    public String prepareMailBody(String username, String passowrd) {
        String body = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"
                ...
                + "  .h1, .h2, .bodycopy {color: #386688; font-family: sans-serif;}"
                ...
                + "                <img class=\"fix\" src=\"https://skyglobal.in/wp-content/uploads/2020/05/ecom-express-1.png\" width=\"150\" height=\"70\" border=\"0\" alt=\"\" />"
                + "              </td>"
                + "            </tr>"
                + "          </table>"
                + "          <!--[if (gte mso 9)|(IE)]>"
                ...
                + "            <tr>"
                + "              <td class=\"h2\">"
                + "				Your onboard request has been approved by the admin"
                + "              </td>"
                + "            </tr>"
                + "            <tr>"
                + "              <td class=\"bodycopy\">"
                + "				Kindly find the below details: <br><br>"
                ...
                + ""
                + "				<td class=\"bodycopy\">"
                + "					<p>It is strogly advised to change your password on your first login.<p>"
                + "				</td>"
                + "			</tr>"
                + "			"
                + "			<tr>"
                + ""
                + "				<td class=\"bodycopy\">"
                + "					<br>If you have any query feel free to email us at <a href=\"#\" class=\"unsubscribe\">info@bpaassolution.com</a> "
                + "				</td>"
                + "			</tr>"
                + "			<tr>"
                + ""
                + "				<td class=\"bodycopy\">"
                + "					<br>Best Regards,<br>Team BPAAS Solutions"
                + "				</td>"
                + "			</tr>"
                + "			"
                + "			"
                ...
                + "                &reg; BPAAS Solutions, India 2020<br/>"
