...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group row">
                                                                    <label class="col-sm-5" title="Total Freight (Total Trip Cost)">Total
                                                                        Freight</label>
                                                                    <div class="col-sm-7">
                                                                        <input type="text" class="form-control" id="totalFreight" name="totalFreight">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <button type="button" class="btn btn-info" id="recalculate" style="margin-right: 10px; width: inherit">Re-Calculate</button>
                                                                        &nbsp;&nbsp;
    ...
    <script src="js/pendingApprovalNetwork.js"></script>
</body>
