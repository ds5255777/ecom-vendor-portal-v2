...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
                                                    ...
                                                    <div class="col-md-3" style="display: none">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5" title="Trip Opening Reading">Start
                                                                Reading</label>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="openingReading" disabled name="openingReading">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3" style="display: none">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5" title="Trip Closing Reading">End
                                                                Reading</label>
                                                            <div class="col-sm-7">
                                                                <input type="text" class="form-control" id="closingReading" disabled name="closingReading">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="js/getApprovedAdhocTrips.js"></script>
</body>
