...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    ...
    <div class="wrapper">
        ...
        <!-- Main Sidebar Container -->
         <jsp:include page="slidebar_Finance.jsp?pagename=paymentRelaseInvoice" />
                        ...
                        <div class="col-md-12" style="font-size: 14px;">
                            ...
                            <div class="card card-primary ">
                                <div class="card-header">
                                    <h3 class="card-title" style="font-size: 15px;">Payment Release Invoice List</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body ">
                    ...
                    success: function(data) {
                        ...
                        if (data.msg == 'success') {
                            ...
                            for (var i = 0; i < result.length; i++) {
                                ...
                                var view = "<a href=\"#\" data-toggle=\"modal\" data-target=\"#tripValue\" onclick=\"getInvoiceDataFormDataByInvoiceNumber('" + result[i].invoiceNumber + "','Payment Relase')\" >" + result[i].ecomInvoiceNumber + "</button>";
