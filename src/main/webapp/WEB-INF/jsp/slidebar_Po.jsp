...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<c:if test="${vendorType.equalsIgnoreCase(typeOfVendor) }">
					...
					<li class="nav-item has-treeview"><a href="#" class="nav-link">
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"><a href="allPO"
								class="nav-link
	...
	out.print("active");
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"><a href="unprocessPO"
								class="nav-link
	...
	out.print("active");
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"><a href="processPO"
								class="nav-link
	...
	out.print("active");
				...
				<li class="nav-item has-treeview"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="poInvoiceDetails"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="draftPO"
							class="nav-link
	...
	out.print("active");
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="QueryPo"
							class="nav-link
