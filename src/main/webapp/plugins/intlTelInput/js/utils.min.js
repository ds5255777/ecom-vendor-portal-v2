!function () {
    ...
    function d(d, $) {
        ...
        for (; d.length && (n = d.shift()); )
            d.length || void 0 === $ ? t = t[n] && t[n] !== Object.prototype[n] ? t[n] : t[n] = {}
         : t[n] = $
    }
    function $(d, r) {
        function $() {}
    ...
    var u = Array.prototype.indexOf ? function (d, $, n) {
     ...
     : function (d, $, n) {
        if (n = null == n ? 0 : n < 0 ? Math.max(0, d.length + n) : n, t(d))
    ...
    function r(d, $) {
        switch (this.a = d, this.h = !!$.i, this.c = $.b, this.m = $.type, this.l = !1, this.c) {
        case o:
        case l:
        case c:
        case s:
    ...
    p = 18;
    function C(d, $) {
        for (this.c = d, this.a = {}, d = 0; d < $.length; d++) {
            var n = $[d];
            this.a[n.a] = n
        }
    }
    ...
    g.prototype.clone = function () {
        ...
        return d != this && (d.a = {}, d.c && (d.c = {}), function d($, n) {
            for (var t = h($.f()), e = 0; e < t.length; e++) {
                ...
                if (null != n.a[u]) {
                    ...
                    if (r.h) {
                        ...
                        r = S(n, u), i ? (i = S($, u)) ? d(i, r) : A($, u, r.clone()) : A($, u, r)
                }
            }
        }
            (d, this)),
    ...
    V = {
        ...
        GG: [, [, , "(?:1481|[357-9]\\d{3})\\d{6}|8\\d{6}(?:\\d{2})?", , , , , , , [7, 9, 10], [6]], [, , "1481[25-9]\\d{5}", , , , "1481256789", , , [10], [6]], [, , "7(?:(?:781|839)\\d|911[17])\\d{5}", , , , "7781123456", , , [10]], [, , "80[08]\\d{7}|800\\d{6}|8001111", , , , "8001234567"], [, , "(?:8(?:4[2-5]|7[0-3])|9(?:[01]\\d|8[0-3]))\\d{7}|845464\\d", , , , "9012345678", , , [7, 10]], [, , , , , , , , , [-1]], [, , "70\\d{8}", , , , "7012345678", , , [10]], [, , "56\\d{8}", , , , "5612345678", , , [10]], "GG", 44, "00", "0", , , "0|([25-9]\\d{5})$", "1481$1", , , , , [, , "76(?:0[0-2]|2[356]|34|4[01347]|5[49]|6[0-369]|77|81|9[39])\\d{6}", , , , "7640123456", , , [10]], , , [, , , , , , , , , [-1]], [, , "(?:3[0347]|55)\\d{8}", , , , "5512345678", , , [10]], , , [, , , , , , , , , [-1]]],
        ...
        MY: [, [, , "1\\d{8,9}|(?:3\\d|[4-9])\\d{7}", , , , , , , [8, 9, 10], [6, 7]], [, , "(?:3(?:2[0-36-9]|3[0-368]|4[0-278]|5[0-24-8]|6[0-467]|7[1246-9]|8\\d|9[0-57])\\d|4(?:2[0-689]|[3-79]\\d|8[1-35689])|5(?:2[0-589]|[3468]\\d|5[0-489]|7[1-9]|9[23])|6(?:2[2-9]|3[1357-9]|[46]\\d|5[0-6]|7[0-35-9]|85|9[015-8])|7(?:[2579]\\d|3[03-68]|4[0-8]|6[5-9]|8[0-35-9])|8(?:[24][2-8]|3[2-5]|5[2-7]|6[2-589]|7[2-578]|[89][2-9])|9(?:0[57]|13|[25-7]\\d|[3489][0-8]))\\d{5}", , , , "323856789", , , [8, 9], [6, 7]], [, , "1(?:4400|8(?:47|8[27])[0-4])\\d{4}|1(?:0(?:[23568]\\d|4[0-6]|7[016-9]|9[0-8])|1(?:[1-5]\\d\\d|6(?:0[5-9]|[1-9]\\d)|7(?:0\\d|1[01]|2[2-6]))|(?:(?:[269]|59)\\d|[37][1-9]|4[235-9])\\d|8(?:1[23]|[236]\\d|4[06]|5[7-9]|7[016-9]|8[01]|9[0-8]))\\d{5}", , , , "123456789", , , [9, 10]], [, , "1[378]00\\d{6}", , , , "1300123456", , , [10]], [, , "1600\\d{6}", , , , "1600123456", , , [10]], [, , , , , , , , , [-1]], [, , , , , , , , , [-1]], [, , "15(?:4(?:6[0-4]\\d|8(?:0[125]|[17]\\d|21|3[01]|4[01589]|5[014]|6[02]))|6(?:32[0-6]|78\\d))\\d{4}", , , , "1546012345", , , [10]], "MY", 60, "00", "0", , , "0", , , , [[, "(\\d)(\\d{3})(\\d{4})", "$1-$2 $3", ["[4-79]"], "0$1"], [, "(\\d{2})(\\d{3})(\\d{3,4})", "$1-$2 $3", ["1(?:[02469]|[378][1-9])|8"], "0$1"], [, "(\\d)(\\d{4})(\\d{4})", "$1-$2 $3", ["3"], "0$1"], [, "(\\d)(\\d{3})(\\d{2})(\\d{4})", "$1-$2-$3-$4", ["1[36-8]"]], [, "(\\d{3})(\\d{3})(\\d{4})", "$1-$2 $3", ["15"], "0$1"], [, "(\\d{2})(\\d{4})(\\d{4})", "$1-$2 $3", ["1"], "0$1"]], , [, , , , , , , , , [-1]], , , [, , , , , , , , , [-1]], [, , , , , , , , , [-1]], , , [, , , , , , , , , [-1]]],
    ...
    q = /(\$\d)/;
    function dd(d) {
        return !(d.length < 2) && Td(z, d)
    }
    function $d(d) {
        return Td(k, d) ? ed(d, w) : ed(d, Z)
    }
    function nd(d) {
        var $ = $d(d.toString());
        d.c = "",
    ...
    function ud(d, $, n) {
        ...
        d: {
            for (var r, u = (d = 0 == M(d, 20).length || 2 == n ? M(d, 19) : M(d, 20)).length, i = 0; i < u; ++i) {
                var a = T(r = d[i], 3);
                if ((0 == a || 0 == e.search(b(r, 3, a - 1))) && Td(a = new RegExp(b(r, 1)), e)) {
                    d = r;
                    break d
                }
            }
        ...
        return null != d && (d = m(u = d, 2), r = new RegExp(b(u, 1)), m(u, 5), u = m(u, 4), e = 2 == n && null != u && 0 < u.length ? e.replace(r, d.replace(q, u)) : e.replace(r, d), 3 == n && (e = (e = e.replace(/^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/, "")).replace(/[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/g, "-"))),
        fd(t, n, e, $)
    }
    function id(d, $, n) {
        return cd(d, "001" == n ? "" + $ : n)
    ...
    function ld(d, $) {
        return sd(d, b($, 1)) ? sd(d, b($, 5)) ? 4 : sd(d, b($, 4)) ? 3 : sd(d, b($, 6)) ? 5 : sd(d, b($, 8)) ? 6 : sd(d, b($, 7)) ? 7 : sd(d, b($, 21)) ? 8 : sd(d, b($, 25)) ? 9 : sd(d, b($, 28)) ? 10 : sd(d, b($, 2)) ? b($, 18) || sd(d, b($, 3)) ? 2 : 0 : !b($, 18) && sd(d, b($, 3)) ? 1 : -1 : -1
    }
    function cd(d, $) {
        if (null == $)
            return null;
    ...
    function sd(d, $) {
        var n = d.length;
        return !(0 < T($, 9) && -1 == u(M($, 9), n)) && Td(m($, 2), d)
    }
    function pd(d, $) {
        if (null == $)
            return null;
    ...
    function hd(d, $, n, t) {
        var e = 0 == T(r = od(n, t), 9) ? M(b(n, 1), 9) : M(r, 9),
        r = M(r, 10);
        if (2 == t) {
            if (!td(od(n, 0)))
                return hd(d, $, n, 1);
            td(d = od(n, 1)) && (i(e = e.concat(0 == T(d, 9) ? M(b(n, 1), 9) : M(d, 9))), 0 == r.length ? r = M(d, 10) : i(r = r.concat(M(d, 10))))
        }
        return -1 == e[0] ? 5 : ($ = $.length, -1 < u(r, $) ? 4 : (n = e[0]) == $ ? 0 : $ < n ? 2 : e[e.length - 1] < $ ? 3 : -1 < u(e, $, 1) ? 0 : 5)
    }
    function gd(d, $) {
        var n = ad($);
        return ($ = m($, 1))in F ? hd(d, n, $ = id(d, $, Cd($)), -1) : 1
    }
    function Sd(d, $, n, t, e, r) {
        if (0 == $.length)
            return 0;
        $ = new B($),
        null != n && (i = b(n, 11)),
        ...
        i,
        a = $.toString();
        if (i = 0 == a.length ? 20 : W.test(a) ? (a = a.replace(W, ""), $.c = "", $.a($d(a)), 1) : (a = new RegExp(i), nd($), (i = 0 == (i = $.toString()).search(a) && (a = i.match(a)[0].length, !((u = i.substring(a).match(Y)) && null != u[1] && 0 < u[1].length && "0" == ed(u[1], Z)) && ($.c = "", $.a(i.substring(a)), !0))) ? 5 : 20), e && A(r, 6, i), 20 == i)
            return null != n && (a = "" + (i = m(n, 10)), 0 == (u = $.toString()).lastIndexOf(a, 0) && (a = new B(u.substring(a.length)), u = b(n, 1), u = new RegExp(m(u, 2)), bd(a, n, null), a = a.toString(), !Td(u, $.toString()) && Td(u, a) || 3 == hd(d, $.toString(), n, -1))) ? (t.a(a), e && A(r, 6, 10), A(r, 1, i), i) : (A(r, 1, 0), 0);
        if ($.c.length <= 2)
            throw Error("Phone number too short after IDD");
        d: {
            if (0 != (d = $.toString()).length && "0" != d.charAt(0))
                for (e = d.length, $ = 1; $ <= 3 && $ <= e; ++$)
    ...
    function bd(d, $, n) {
        ...
        i = u.length,
        a = b($, 15);
        0 == i || null == a || 0 == a.length || (i = (t = new RegExp("^(?:" + a + ")")).exec(u)) && (e = Td(a = new RegExp(m(b($, 1), 2)), u), r = i.length - 1, null == ($ = b($, 16)) || 0 == $.length || null == i[r] || 0 == i[r].length ? e && !Td(a, u.substring(i[0].length)) || (null != n && 0 < r && null != i[r] && n.a(i[1]), d.set(u.substring(i[0].length))) : (u = u.replace(t, $), e && !Td(a, u) || (null != n && 0 < r && n.a(i[1]), d.set(u))))
    }
    function md(d, $, n) {
        if (!rd(n) && 0 < $.length && "+" != $.charAt(0))
            throw Error("Invalid country calling code");
        return Md(d, $, n, !0)
    }
    function Md($, n, d, t) {
        ...
        i,
        a = new B,
        f = n.indexOf(";phone-context=");
        if (0 <= f ? (e = f + 15, "+" == n.charAt(e) && (0 < (r = n.indexOf(";", e)) ? a.a(n.substring(e, r)) : a.a(n.substring(e))), e = n.indexOf("tel:"), a.a(n.substring(0 <= e ? e + 4 : 0, f))) : a.a((0 <= (i = (u = n).search(J)) ? 0 <= (i = (u = (u = u.substring(i)).replace(Q, "")).search(X)) && (u = u.substring(0, i)) : u = "", u)), 0 < (e = (f = a.toString()).indexOf(";isub=")) && (a.c = "", a.a(f.substring(0, e))), !dd(a.toString()))
            throw Error("The string supplied did not seem to be a phone number");
        if (f = a.toString(), !(rd(d) || null != f && 0 < f.length && W.test(f)))
            throw Error("Invalid country calling code");
        f = new U,
        t && A(f, 5, n);
        d: {
            if (0 <= (e = (n = a.toString()).search(j)) && dd(n.substring(0, e)))
                for (var o = (r = n.match(j)).length, l = 1; l < o; ++l)
        ...
        try {
            ...
            if ("Invalid country calling code" != d.message || !W.test(o))
                throw d;
            if (0 == (r = Sd($, o = o.replace(W, ""), e, n, t, f)))
                throw d
        }
        if (0 != r ? (a = Cd(r)) != d && (e = id($, r, a)) : (nd(a), n.a(a.toString()), null != d ? A(f, 1, r = m(e, 10)) : t && (delete f.a[6], f.c && delete f.c[6])), n.c.length < 2)
            throw Error("The string supplied is too short to be a phone number");
        if (null != e && (d = new B, bd(a = new B(n.toString()), e, d), 2 != ($ = hd($, a.toString(), e, -1)) && 4 != $ && 5 != $ && (n = a, t && 0 < d.toString().length && A(f, 7, d.toString()))), ($ = (t = n.toString()).length) < 2)
            throw Error("The string supplied is too short to be a phone number");
        if (17 < $)
            throw Error("The string supplied is too long to be a phone number");
        if (1 < t.length && "0" == t.charAt(0)) {
            for (A(f, 4, !0), $ = 1; $ < t.length - 1 && "0" == t.charAt($); )
                $++;
            1 != $ && A(f, 8, $)
        }
        return A(f, 2, parseInt(t, 10)),
        f
    }
    function Td(d, $) {
    ...
    d("intlTelInputUtils.formatNumber", function ($, d, n) {
        try {
            ...
            e = md(t, $, d),
            r = gd(t, e);
            return 0 == r || 4 == r ? ud(t, e, void 0 === n ? 0 : n) : $
        } catch (d) {
            return $
        }
    }),
    ...
    d("intlTelInputUtils.getValidationError", function (d, $) {
        try {
            ...
            return "Invalid country calling code" == d.message ? 1 : "Phone number too short after IDD" == d.message || "The string supplied is too short to be a phone number" == d ? 2 : "The string supplied is too long to be a phone number" == d.message ? 3 : -99
        }
    }),
