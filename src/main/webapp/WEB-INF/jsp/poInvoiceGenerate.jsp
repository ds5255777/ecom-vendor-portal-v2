                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control-sm" name="remitToBankAccountName" id="remitToBankAccountName" onkeypress="return event.charCode >= 65 && event.charCode <= 122 || event.charCode == 32" placeholder="Remit To bank account name" maxlength="70" style="width: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control-sm" type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="Account" maxlength="70" name="account" id="account"  style="width: 100%;">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control-sm" type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" placeholder="Invoice Type" name="amount" id="amount" maxlength="70"  style="width: 100%;">
                                            </div>
                                        </div>
                                    </div>
