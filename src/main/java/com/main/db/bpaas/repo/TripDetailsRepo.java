...
public interface TripDetailsRepo extends JpaRepository<TripDetails, Integer> {
	...
	@Transactional
	@Modifying
	@Query(value = "update Trip_Details set " + "processed_By=:processed_By,processed_On=:processed_On,"
	...
	public void updateDetailsByNetworkInQuery(@Param("tripID") String tripID,
			...
			@Param("fs_diff") double fs_diff, @Param("basicFreight") double basicFreight,
