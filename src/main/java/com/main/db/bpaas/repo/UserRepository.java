...
*/	
	...
	List<User> getUsersByRoleAndProjectAndSite(@Param("role") String roleInternalInspector, @Param("userStatusList")  List<String> userStatusList,@Param("activeStatus") String activeStatus, @Param("projectForeignKey") Integer projectForeignKey, @Param("siteForeignKey") Integer siteForeignKey);
	...
	List<User> getUsersByRoleAndAllProjectAndSite(@Param("role") String role,@Param("userStatusList")  List<String> userStatusList,@Param("activeStatus") String activeStatus);
