...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
                                    ...
                                    <form role="form" id="addForm" autocomplete="off">
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <button type="button" id="searchallinvfin" style="imargin-right: 5px; height: 30px; padding: 2px 10px 2px 10px;" class="btn btn-primary">Search</button>
                                            </div>
    ...
    <script src="js/allInvoices_Finance.js"></script>
</body>
