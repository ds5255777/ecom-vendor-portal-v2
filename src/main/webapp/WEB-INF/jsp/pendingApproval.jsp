                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" onclick="updateTripData()" id="updateBtnBtn" name="updateBtnBtn" class="btn btn-primary">Approve</button>
                                ...
                                <div class="col-md-7 propTableContainer" style="overflow-y: auto; height: 650px;">
                                    ...
                                    <table class="table table-striped" id="tripDetailsTable">
                                        <div class="card card-primary">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <form role="form" id="tripDetails" name="tripDetails">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control numberWithDecimalcheck" style="height: 30px;" placeholder="Enter" autocomplete="off" id="openingReading" name="openingReading" disable>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <!-- text input -->
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" style="height: 30px;" placeholder="Enter" id="closingReading" name="closingReading" disable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
