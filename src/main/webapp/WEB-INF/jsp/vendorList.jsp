...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
								...
								<form role="form" id="addForm" autocomplete="off">
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label for="vendorType">Vendor Type</label> <select
														class="js-example-basic-multiple1 select2"
											...
											<div class="col-md-3">
												<div class="form-group">
													<label for="creditTerms">Payment/Credit Terms</label> <select
														id="creditTerms" name="creditTerms"
											...
											<div class="col-md-3">
												<div class="form-group">
													<label for="verifierName">Verifier Name</label> <select
														id="verifierName" name="verifierName"
														class="form-control p-input">
														<option value="">Select</option>
													</select>
												</div>
											...
											<div class="col-md-3">
												<div class="form-group">
													<label for="status">Status</label> <select id="status"
														name="status" class="form-control p-input">
														<option value="">Select</option>
														<option value="Pending For Commercial Team">Pending
															At Commercial Team</option>
														<option value="pending at commercial head">Pending
															At Commercial Head</option>
														<option value="pending at vendor">Pending At
															Vendor</option>
														<option value="pending at vendor upon raise query">Pending
															At Vendor Upon Raise Query</option>
														<option value="Pending at Verifier">Pending At
															Verifier</option>
														<option value="Rejected by Verifier">Rejected By
															Verifier</option>
														<option value="Pending For Ehs Verification at AM/DM">Pending
															at AM/DM For Ehs Verification</option>
														<option value="Pending at Senior Manager For Ehs Verification">Pending
															at Senior Manager For Ehs Verification</option>
														<option value="Pending For Approval">Pending
															At Doc Checker</option>
									...
									<table id="tabledata" class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="bg-primary">Vendor Pid</th>
	...
	<script src="js/vendorList.js"></script>
</body>
