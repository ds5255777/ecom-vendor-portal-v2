...
<head>
    ...
    <title>${titleName}|Closed and Adhoc Trips</title>
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
                                        ...
                                        <table class="table table-head-fixed" id="tabledata1">
                                            ...
                                            <tbody>
                                                <%-- <c:forEach var="ApprovedAllDetails" items="${AllDetailsForNetwork}">
                                                    <tr>
                                                        <td><a href="#" class="tripIdView">${ApprovedAllDetails.tripID}</a></td>
                                            ...
                                            <div class="card-body" style="padding-bottom: inherit;">
                                                <form role="form" id="tripForm1">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group row">
                                                                <label class="col-sm-5" title="Opening Reading">Opening Reading</label>
                                                                <div class="col-sm-7">
                                                                    <input type="text" class="form-control" id="openingReading" name="openingReading" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group row">
                                                                <label class="col-sm-5" title="Closing Reading">Closing Reading</label>
                                                                <div class="col-sm-7">
                                                                    <input type="text" class="form-control" id="closingReading" name="closingReading" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script src="js/ClosedAdhoc.js"></script>
